...
class OperatingCostsProfitModel(trac.TracModel):
    ...
    def define_outputs(self) -> tp.Dict[str, trac.ModelOutputSchema]:
        ...
        return {"operating_profit": trac.ModelInputSchema(operating_profit),
                "total_income": trac.ModelInputSchema(total_income)}

    def run_model(self, ctx: trac.TracContext):
        ctx.log().info("Operatinng costs profit model is running...")
