...
class NonInterestIncomeDataModel(trac.TracModel):
    ...
    def define_inputs(self) -> tp.Dict[str, trac.ModelInputSchema]:
        ...
        fees_and_commisions_income = trac.load_schema(schemas, "fees_and_commissions_income.csv")
        return {"investment_income": trac.ModelInputSchema(investment_income),
                "fees_and_commissions_income": trac.ModelInputSchema(fees_and_commisions_income)}
